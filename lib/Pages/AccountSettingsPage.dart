...
class SettingsScreenState extends State<SettingsScreen>
{
  ...
  Future uploadImageToFirestoreAndStorage() async {
    String nFileName = id;
    Reference storageReference = FirebaseStorage.instance.ref().child(nFileName);
    UploadTask storageUploadTask = storageReference.putFile(File(imageFileAvatar!.path));
