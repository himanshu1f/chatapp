...
class ChatScreenState extends State<ChatScreen>
{
  ...
  readLocal() async
  {
    ...
    FirebaseFirestore.instance.collection("users").doc(id).update({'chattingWith' : widget.receiverId});
  ...
  Future uploadImageFile() async
  {
    ...
    UploadTask storageUploadTask = storageReference.putFile(File(imageFile!.path));
